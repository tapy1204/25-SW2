...
#define _DUTY_MIN 10  // servo full clock-wise position (0 degree)
...
#define EMA_ALPHA  0.6      // for EMA Filter
...
void loop()
{
  ...
  if(dist_ema >= _DIST_MIN && dist_ema <= _DIST_MAX){
    digitalWrite(PIN_LED, LOW); //Put range Filter code herez (_DIST_MIN ~ _DIST_MAX)
